...
# This has been generated using oh-my-posh init nu --config `/home/tigrou/ownCloud/Shell/Oh My Posh/herve.omp.json` --print | save -f /home/tigrou/ownCloud/Shell/Linux/.nu_advanced_profile
...
$env.POSH_THEME = (echo "/home/tigrou/ownCloud/Shell/Oh My Posh/herve.omp.json")
$env.PROMPT_INDICATOR = ""
$env.POSH_SESSION_ID = (echo "46f8b1c5-03e9-41ed-9710-b77b2b6a6931")
$env.POSH_SHELL = "nu"
...
let _omp_executable: string = (echo "/home/tigrou/.local/bin/oh-my-posh")
